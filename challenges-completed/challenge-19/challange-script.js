...
console.log("121ds\n1212dsds".match(justNumbersRegex))
/*
...
let hasClass =  (markup, cssClass) =>{
    classMatch = new RegExp('class=["\']([\\w\\s]+)?' + cssClass + '([\\s\\w]+)?["\']', "gmi")

    return classMatch.test(markup)
}

const classList = ["container", "text", "date", "excerpt", "main"];
