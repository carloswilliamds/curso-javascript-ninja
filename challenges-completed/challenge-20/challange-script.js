window.onload = function(){ (function(win, doc){
/*
...
*/
let email = prompt("Fala seu e-mail ai carai");
email ? console.log(email) : email = "Desconhecido@suamae.com"; console.log(email)

/*
- Selecione o input de "Nome", atribuindo-o à uma variável chamada
`$inputUsername`.
*/
let $inputName = doc.querySelector("[type='text']")
...
$button.addEventListener("click", (event) => {
    ...
    if(!$inputName.value){
        console.log("sua mae nao preencheu o nome")
    }
    if(!$inputEmail.value){
